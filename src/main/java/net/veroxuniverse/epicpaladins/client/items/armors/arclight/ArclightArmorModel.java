...
public class ArclightArmorModel extends GeoModel<ArclightArmorItem> {
    ...
    public ResourceLocation getModelResource(ArclightArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "geo/arclight_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ArclightArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "textures/armor/arclight_armor_textures.png");
    }
