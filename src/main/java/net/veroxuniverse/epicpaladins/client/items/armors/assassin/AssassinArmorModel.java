...
public class AssassinArmorModel extends GeoModel<AssassinArmorItem> {
    ...
    public ResourceLocation getModelResource(AssassinArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "geo/assassin_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AssassinArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "textures/armor/assassin_armor_textures.png");
    }
