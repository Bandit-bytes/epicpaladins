...
public class MoonlightArmorModel extends GeoModel<MoonlightArmorItem> {
    ...
    public ResourceLocation getModelResource(MoonlightArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "geo/moonlight_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MoonlightArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "textures/armor/moonlight_armor_textures.png");
    }
