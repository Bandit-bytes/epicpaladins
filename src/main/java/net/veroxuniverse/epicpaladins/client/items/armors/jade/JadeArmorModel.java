...
public class JadeArmorModel extends GeoModel<JadeArmorItem> {
    ...
    public ResourceLocation getModelResource(JadeArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "geo/jade_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(JadeArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "textures/armor/jade_armor_textures.png");
    }
