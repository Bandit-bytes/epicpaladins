...
public class BloodstoneArmorModel extends GeoModel<BloodstoneArmorItem> {
    ...
    public ResourceLocation getModelResource(BloodstoneArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "geo/bloodstone_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(BloodstoneArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "textures/armor/bloodstone_armor_textures.png");
    }
