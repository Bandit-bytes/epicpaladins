...
public class CryoriumArmorModel extends GeoModel<CryoriumArmorItem> {
    ...
    public ResourceLocation getModelResource(CryoriumArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "geo/cryorium_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CryoriumArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "textures/armor/cryorium_armor_textures.png");
    }
