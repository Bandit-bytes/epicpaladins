...
public class SculkArmorModel extends GeoModel<SculkArmorItem> {
    ...
    public ResourceLocation getModelResource(SculkArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "geo/sculk_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(SculkArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(EpicPaladinsMod.MOD_ID, "textures/armor/sculk_armor_textures.png");
    }
